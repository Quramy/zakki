...
## Next.js の dist に docs が同梱されている

https://nextjs.org/docs/app/guides/ai-agents で知った

`node_modules/next/dist/docs/` に格納されている、ということだが、書きっぷりてきには v16.2.0-canary.37 以降から同梱するようにした、ということっぽい。
