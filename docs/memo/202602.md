...
今年の Interop が WebKit blog で紹介されていた。
...
- CSS Scroll Snap: Baseline に入ってなかったっけ？と思ったが、「しかし、多くの古いCSS仕様と同様に、初期バージョンが既にブラウザに実装されている間に仕様が何度も変更されたことで、相互運用性が大きく欠如していました。Web標準がはるかに成熟した今こそ、相互運用性を改善する時です」とのこと
